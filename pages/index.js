              ...
              <Card>
                <div className="top">
                  ...
                  >
                    ...
                    <path d="M28.0001 0H22.6667C20.4571 0 18.6667 1.79031 18.6667 4V9.33331C18.6667 11.543 20.4571 13.3333 22.6667 13.3333H28.0001C30.2097 13.3333 32.0001 11.543 32.0001 9.33331V4C32.0001 1.79031 30.2097 0 28.0001 0ZM29.3334 9.33331C29.3334 10.0702 28.737 10.6666 28.0001 10.6666H22.6667C21.9298 10.6666 21.3334 10.0702 21.3334 9.33331V4C21.3334 3.26306 21.9298 2.66669 22.6667 2.66669H28.0001C28.737 2.66669 29.3334 3.26306 29.3334 4V9.33331Z"></path>
                    ...
                    <path d="M30.6667 24.0001H26.6667V20.0001C26.6667 19.2637 26.0698 18.6667 25.3334 18.6667C24.597 18.6667 24.0001 19.2637 24.0001 20.0001V24.0001H20.0001C19.2637 24.0001 18.6667 24.597 18.6667 25.3334C18.6667 26.0697 19.2637 26.6667 20.0001 26.6667H24.0001V30.6667C24.0001 31.4031 24.597 32 25.3334 32C26.0697 32 26.6667 31.4031 26.6667 30.6667V26.6667H30.6667C31.4031 26.6667 32 26.0697 32 25.3334C32.0001 24.597 31.4031 24.0001 30.6667 24.0001Z"></path>
                  </svg>
                </div>
