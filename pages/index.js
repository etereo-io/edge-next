  ...
  return (
    <>
          ...
          <div className="right-column">
            <div className="call-to-action-item">
              <a href="/components">
                ...
                <h6>Components</h6>
                <p>
                  Complete set of ready to use web components.
                </p>
              </a>
            </div>
            <div className="call-to-action-item alt">
              <a href="/content/post">
                ...
                <p>
                  Dynamic content that loads at lightning speed.
                </p>
              </a>
            </div>
            <div className="call-to-action-item featured">
              <a href="https://webmonetization.org/">
                ...
                <p>
                  Integrate a simple JS API to create payment stream with just a few lines of code.
                </p>
              </a>
            </div>
      ...
      <style jsx>{`
        ...
        .call-to-action-item.featured h6, .call-to-action-item.featured p{
          color: var(--empz-background);
        }
