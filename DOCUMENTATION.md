...
With this functionality you can see specific information (total/today total/ etc.) for entities that you've configured before via `edge.config.js` file.
