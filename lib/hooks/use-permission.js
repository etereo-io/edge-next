...
export default function(permission, redirectIfNotPermissions, waitUntilRouterReadyForSlug) {
  ...
  useEffect(() => {
    const routerLoaded = (waitUntilRouterReadyForSlug && query[waitUntilRouterReadyForSlug]) || (!waitUntilRouterReadyForSlug)
