...
export const hasPermissionsForGroupUser = (groupType, group) => async (req, res, cb) => {
  const action = getAction(req.method)
...
export const hasPermissionsForGroupContent = (groupType, contentType, group) => async (req, res, cb) => {
  const action = getAction(req.method)
