      ...
      if (session) {
        ...
        try {
          ...
          if (existingUser) {
            ...
            const picture =
              user.profile.picture && user.profile.picture.path ? user.profile.picture.path :
          ...
          if (existingUser) {
            ...
            const user = {
              ...
              profile: {
                ...
                picture:{
                  source: 'facebook',
                  path: `https://graph.facebook.com/${profile.id}/picture?type=large`
                },
              },
            }
      ...
      if (session) {
        ...
        try {
          ...
          if (existingUser) {
            ...
            // Update profile picture of the user
            const picture = user.profile.picture && user.profile.picture.path ? user.profile.picture.path : profile._json.avatar_url

            const location = user.profile.location || profile._json.location

            const website = user.profile.website || profile._json.blog

            const github = user.profile.github || profile.profileUrl
      ...
      if (session) {
        ...
        try {
          ...
          if (existingUser) {
            ...
            const picture = user.profile.picture && user.profile.picture.path ? user.profile.picture.path : profile._json.picture
