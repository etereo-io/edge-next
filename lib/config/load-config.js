  ...
  try {
    ...
    newConfig.groups.types.forEach((type) => {
      ...
      ;(type.contentTypes || []).forEach(contentType => {
        ...
        // Comments
        if (type.comments && type.comments.enabled) {
          availablePermissions[`group.${type.slug}.content.${contentType.slug}.comments.read`] =
            type.comments.permissions.read
          availablePermissions[`group.${type.slug}.content.${contentType.slug}.comments.create`] =
            type.comments.permissions.create
          availablePermissions[`group.${type.slug}.content.${contentType.slug}.comments.update`] =
            type.comments.permissions.update
          availablePermissions[`group.${type.slug}.content.${contentType.slug}.comments.delete`] =
            type.comments.permissions.delete
          availablePermissions[`group.${type.slug}.content.${contentType.slug}.comments.admin`] =
            type.comments.permissions.admin
        }
      })
