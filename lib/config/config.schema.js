...
const FieldSchema = object({
  ...
  type: string().required('Missing field type')
  .matches(`(${FIELDS.TAGS}|${FIELDS.TEXT}|${FIELDS.TEXTAREA}|${FIELDS.IMAGE}|${FIELDS.FILE}|${FIELDS.SELECT}|${FIELDS.NUMBER})`, 'Invalid field type')
})
...
export default object({
  ...
  database: object({
    type: string().matches(`(${DATABASES.FIREBASE}|${DATABASES.IN_MEMORY}|${DATABASES.MONGO})`, 'Invalid database type')
  }),
  activity: object({
