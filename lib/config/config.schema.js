...
const FieldSchema = object({
  ...
  type: string()
    ...
    .matches(
      `(${FIELDS.TAGS}|${FIELDS.TEXT}|${FIELDS.TEXTAREA}|${FIELDS.IMAGE}|${FIELDS.FILE}|${FIELDS.SELECT}|${FIELDS.NUMBER}|${FIELDS.JSON}|${FIELDS.BOOLEAN}|${FIELDS.RADIO}|${FIELDS.VIDEO_URL}|${FIELDS.MARKDOWN}|${FIELDS.DATE}|${FIELDS.URL}|${FIELDS.TEL}|${FIELDS.ENTITY_SEARCH}|${FIELDS.EMAILS}|${FIELDS.TIME}|${FIELDS.DATETIME})`,
      'Invalid field type'
    ),
